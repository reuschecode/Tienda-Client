...
const Container = styled.div`
    ...
    background: linear-gradient(-135deg, #ee9746, #d3152f);
`
        ...
        <Limiter>
            <Container>
                <WrapPage>
                    ...
                    <Texto>
                        <TextoPrincial>¡No autorizado!</TextoPrincial>
                        <br />
                        <TextoSecundario>No estas autorizado a entrar a esta página o no haz iniciado sesión, regresa a la ruta principal.</TextoSecundario>
